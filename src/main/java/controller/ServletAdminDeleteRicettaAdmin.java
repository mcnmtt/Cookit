...
@WebServlet(name = "ServletAdminDeleteRicettaAdmin", value = "/ServletAdminDeleteRicettaAdmin")
public class ServletAdminDeleteRicettaAdmin extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String nome = request.getParameter("ricettaAdmin");
