...
CREATE TABLE `composta` (
  ...
  PRIMARY KEY (`id`),
  KEY `ricettaComposta_idx` (`ricetta`),
  KEY `ingredienteComposta_idx` (`ingrediente`),
  CONSTRAINT `ingredienteComposta` FOREIGN KEY (`ingrediente`) REFERENCES `ingrediente` (`id`),
  CONSTRAINT `ricettaComposta` FOREIGN KEY (`ricetta`) REFERENCES `ricetta` (`id`)
